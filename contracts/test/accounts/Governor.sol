...
contract Governor {
    ...
    function mapleProxyFactory_setMapleGlobals(address factory_, address mapleGlobals_) external {
        IMapleProxyFactory(factory_).setMapleGlobals(mapleGlobals_);
    }
    ...
    function try_mapleProxyFactory_setMapleGlobals(address factory_, address mapleGlobals_) external returns (bool ok_) {
        ( ok_, ) = factory_.call(abi.encodeWithSelector(IMapleProxyFactory.setMapleGlobals.selector, mapleGlobals_));
    }
