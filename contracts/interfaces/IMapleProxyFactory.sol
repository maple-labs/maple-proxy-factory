...
interface IMapleProxyFactory {
    ...
    /**
     *  @dev   A version of implementation, at some address, was registered, with an optional initializer.
     ...
     *  @param fromVersion The starting version of the upgrade path.
     *  @param toVersion   The destination version of the upgrade path.
     *  @param migrator    The address of Migrator, if any.
     */
    ...
    /**
     *  @dev    Deploys a new instance of the latest defined implementation version, with some initialization arguments.
     *  @dev    Uses the nonce and msg.sender as a salt for the CREATE2 opcode during instantiation to give deterministic addresses.
     *  @param  arguments_ The initialization arguments to use for  deployment.
    ...
    /**
     *  @dev   Enables upgrading from a version to a version of a implementation, with an optional migrator.
     ...
     *  @param migrator_    The address of Migrator, if any.
     */
     ...
     *  @dev   Only the Governor can call this function.
     *  @param version_  version to set as the default.
     */
     ...
     *  @param toVersion_  implementation version to upgrade the proxy contract to.
     *  @param arguments_ The migration arguments to use.
     */
    ...
    /**
     *  @dev    Returns whether a contract at an address is a instance.
